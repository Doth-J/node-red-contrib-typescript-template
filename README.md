...
<div style="display:flex; align-content:center;gap:10px"><svg fill="#ffffff" width="25px" height="25px" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
...
</svg><p>This is a Typescript template project for developing Node-RED nodes.</p></div>
